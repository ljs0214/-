...
acc_key = "tLx3BrnozBqXQDsw8BfdxQRZnrFCLdx3HFOEqn0L"
sec_key = "z9GRAU7LpcZj5xHFqmEuLf4fTyc9gopSdLQp6DeF"
...
class autoTrade :
    ...
    def get_today_data(self) :
        ...
        # 노이즈 20일 평균
        daily_data['noise_ma20'] = daily_data['noise'].rolling(window=2).mean().shift(1)
    ...
    def sell_coin(self) :
        balance = upbit.get_balance("KRW_XRP") # 잔고 조회

        upbit.sell_market_order(ticker, balance)
        self.buy_yn = False

ticker = "KRW-BTC"
tradingBot = autoTrade(100000, ticker)
